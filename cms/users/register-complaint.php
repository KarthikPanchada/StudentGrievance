...
$complainno=$cmpn;
echo alert("Your complain has been successfully filled and your complaintno is  "+"'. $complainno.'");
    notifyme();
}
?>
...
<label class="col-sm-2 col-sm-2 control-label"><h4>Complaint Registration Form:</h4></label>
<div class="col-sm-4">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Complaint Details<br>(max 2000 words) </label>
<div class="col-sm-6">
