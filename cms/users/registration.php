...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            ...
		            <br>  
					<input type="text" class="form-control" placeholder="E-mail" id="email" onBlur="userAvailability()" name="text" required="required" autocomplete="off">
		             <span id="user-availability-status1" style="font-size:12px;"></span>
		            <br>
    ...
    <script>
        $.backstretch("assets/img/login-bg.jpg", {speed: 1100});
    </script>
